 ...
 */
@CreoleResource(name = "Structural Similarity PR V3", comment = "finds relations between the sem annotations using fastgraph")
public class StructuralSimilarityPRv3 extends AbstractLanguageAnalyser implements
  ...
  private Logger logger = Logger.getLogger(gate.creole.disambiguation.StructuralSimilarityPRv3.class);  

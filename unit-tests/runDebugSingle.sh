...
runPipeline.sh -nl -c ../main/main.config.yaml  ../main/main.xgapp debug1 d1.afterMain1/

runPipeline.sh -nl  transferShef2Ref.xgapp  d1.afterMain1/ d1.afterTransfer/

runPipeline.sh -nl -Dmodularpipelines.prrun.lookupinfo.Java:copyListAnns=true  -c ../main/main.config.yaml ../main/main.xgapp   d1.afterTransfer/ d1.afterMain2/
